...
Solv is a Manifest V3 extension for checking study questions inline. Users trigger every solve action explicitly by selecting text, using the context menu, pressing a shortcut, typing in the side panel, pasting an image, or dragging a screenshot region.
